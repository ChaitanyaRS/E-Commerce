This is a Multithreaded Ecommerce application, designed with High JWT Security. Also, it is a microservice application where each module is independent on each other.
