...
import {addItemToCart} from "../slice/cartSlice.jsx";
...
const {pid, description, imageLink, price, productName, quantity, r_id} = data;
...
const addToCart = async (productData) => {
    ...
    const productForm = {prodId:productData.pid,userId:userId,quantity:1}

    await dispatch(addItemToCart(productForm));
  ...
  return (
    <div>
      ...
      <CardActions>
        ...
        <Button  variant='contained' size="large" color="primary" onClick={() => addToCart(data)}>
          Add to Cart
        </Button>
        </div>
      </CardActions>
